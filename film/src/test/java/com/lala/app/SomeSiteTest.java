...
public class SomeSiteTest {
	...
	public void failTest() throws Exception {
		...
		driver.findElement(By.cssSelector("#email_create")).sendKeys("niepoprawnyemail");
	...
	public void registerTest() throws Exception {
		...
		//create_account
		driver.findElement(By.cssSelector("#email_create")).clear();
		driver.findElement(By.cssSelector("#email_create")).sendKeys("poprawnyemail3@lala.com");
		driver.findElement(By.cssSelector("#SubmitCreate")).click();
		Thread.sleep(500);		
